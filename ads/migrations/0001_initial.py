# Generated by Django 3.0 on 2020-12-05 15:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ads_users', to=settings.AUTH_USER_MODEL)),
            ],
            options={
